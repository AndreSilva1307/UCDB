...
public abstract class AlunoM {
    ...
    public AlunoM(int ra, String nome_completo, String data_nascimento, DadosPessoaisM dadosPessoaisM, EnderecoM enderecoM) {
        this.ra = ra;
    ...
    public void imprimirAlunoM() {
        System.out.println("");
        System.out.println("...::   DADOS GERAIS DO ALUNO    ::...");
        System.out.println("RA                 : " + getRa());
        System.out.println("Nome Completo      : " + getNome_completo());
